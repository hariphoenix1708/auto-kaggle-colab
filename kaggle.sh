...
# --- MODELS, LORAS, VAE --- #
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/phoenix-1708/DR_NED/resolve/main/malklat-woman-1611-malklat.ckpt -d /content/stable-diffusion-webui/models/Stable-diffusion -o malklat-woman-1611-malklat.ckpt
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/phoenix-1708/DR_NED/resolve/main/iswmnn-woman-1886-iswmnn.ckpt -d /content/stable-diffusion-webui/models/Stable-diffusion -o iswmnn-woman-1886-iswmnn.ckpt
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/phoenix-1708/DR_NED/resolve/main/DR_NED_120623.safetensors -d /content/stable-diffusion-webui/models/Stable-diffusion -o DR_NED_120623.safetensors
...
git clone https://github.com/Elldreth/loopback_scaler /content/stable-diffusion-webui/extensions/loopback_scaler
git clone https://github.com/hariphoenix1708/fswap /content/stable-diffusion-webui/extensions/roop
